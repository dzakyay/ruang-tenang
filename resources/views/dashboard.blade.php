<x-app-layout>
    ...
    <div x-data="dashboardPage()" class="px-6 lg:px-10 py-12 max-w-7xl mx-auto">
        ...
        <div class="mb-10 flex items-start justify-between">
            ...
            @if($todayEmotion)
                <div class="hidden lg:flex items-center gap-2 bg-white rounded-2xl px-4 py-2.5 shadow-sm border border-[#e8dbce]/50 text-sm text-[#614d3c]">
            ...
            @else
                <button @click="showMoodModal = true"
                        class="hidden lg:flex items-center gap-2 bg-[#5c442b] text-white text-sm font-medium px-5 py-2.5 rounded-2xl hover:bg-[#4a3622] transition shadow-sm">
        ...
        <div class="relative bg-gray-200 rounded-3xl overflow-hidden shadow-sm">
            ...
            <div class="relative z-10 p-10 lg:p-14 max-w-xl">
                ...
                <p class="text-gray-700 mb-8 leading-relaxed">Temukan perasaan yang membuat anda menyesakkan dan membingungkan.</p>
