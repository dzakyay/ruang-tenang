...
<body class="bg-[#F9F7F4] font-sans antialiased min-h-screen flex items-center justify-center p-4">
    ...
    <div
        class="bg-white rounded-[2rem] shadow-2xl overflow-hidden w-full max-w-5xl flex flex-col md:flex-row min-h-[600px]">

        <!-- Left Side -->
        <div class="w-full md:w-[45%] relative hidden md:block">
            <img src="{{ asset('images/admin_login.png') }}" alt="RuangTenang"
