...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-background">
        <div class="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8">
            <div class="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px] mb-8">
                ...
                <div class="md:w-1/2 relative bg-primary hidden md:block">
                    ...
                    <div class="absolute bottom-10 left-10 right-10 text-white">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <h1 class="font-serif text-3xl font-semibold italic">RuangTenang</h1>
                        </div>
                ...
                <!-- Right Side (Form) -->
                <div class="w-full md:w-1/2 flex flex-col justify-center p-8 lg:p-12 relative">
                    {{ $slot }}
                </div>
            </div>
