...
<body class="font-sans antialiased bg-background text-gray-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-shrink-0 flex items-center gap-2">
                    <svg class="w-8 h-8 fill-current text-primary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    <a href="#tentang" class="text-sm font-medium text-gray-600 hover:text-primary border-b-2 border-primary pb-1">Tentang Kami</a>
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm font-medium text-gray-600 hover:text-primary">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-600 hover:text-primary hidden sm:block">Masuk</a>
                        <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-6 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-primary hover:bg-primary-dark transition shadow-sm">
                            Mulai Sekarang
                        </a>
                    @endauth
                </div>
    ...
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
                ...
                <div class="lg:w-1/2 flex flex-col items-start text-left">
                    <div class="inline-flex items-center px-4 py-1.5 rounded-full bg-primary/10 text-primary text-xs font-semibold tracking-wide uppercase mb-6">
                    ...
                    <p class="text-lg text-gray-600 mb-8 max-w-lg leading-relaxed">
                        Berikan diri Anda ruang untuk bernapas. Temukan keseimbangan emosional melalui panduan ahli dan teknologi yang dirancang untuk kedamaian Anda.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-3.5 border border-transparent text-base font-medium rounded-lg text-white bg-primary hover:bg-primary-dark transition shadow-md">
                            Mulai Sekarang
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 relative w-full mt-10 lg:mt-0">
                    <div class="relative rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/5] sm:aspect-square lg:aspect-[4/5]">
                        <img src="{{ asset('images/hero_image.png') }}" alt="Stones in water" class="absolute inset-0 w-full h-full object-cover">
                        
                        <!-- Glassmorphism Quote -->
                        <div class="absolute bottom-6 left-6 right-6 lg:bottom-10 lg:left-10 lg:right-10 bg-white/20 backdrop-blur-xl border border-white/30 p-6 rounded-2xl shadow-lg">
                            <p class="text-white font-medium text-sm lg:text-base leading-relaxed italic">
                                "Ketenangan bukanlah saat Anda jauh dari masalah. Ketenangan adalah saat Anda berada di tengah masalah namun pikiran Anda tetap tenang."
                            </p>
                        </div>
                    </div>
                    <!-- Decorative Element -->
        ...
        <!-- Background Gradient -->
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-orange-50/50 via-background to-background -z-20"></div>
    </section>
    ...
    <section id="fitur" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="bg-background rounded-3xl p-8 hover:-translate-y-2 transition duration-300 shadow-sm hover:shadow-md">
    ...
    <section class="py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-primary/10 rounded-[3rem] p-12 lg:p-20 text-center">
                <h2 class="text-4xl lg:text-5xl font-serif font-bold text-gray-900 mb-6">Siap untuk memulai perjalananmu?</h2>
                <p class="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                    Bergabunglah dengan ribuan orang lainnya yang telah menemukan kedamaian batin mereka kembali.
                </p>
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-10 py-4 border border-transparent text-lg font-medium rounded-xl text-white bg-primary hover:bg-primary-dark transition shadow-lg hover:shadow-xl">
                    Mulai Sekarang
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-sm text-gray-500 hover:text-primary transition">Tentang Kami</a></li>
                        <li><a href="#" class="text-sm text-gray-500 hover:text-primary transition">Kebijakan Privasi</a></li>
                        <li><a href="#" class="text-sm text-gray-500 hover:text-primary transition">Syarat & Ketentuan</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <a href="mailto:halo@ruangtenang.com" class="text-sm font-medium text-primary hover:text-primary-dark transition">halo@ruangtenang.com</a>
                </div>
            </div>
