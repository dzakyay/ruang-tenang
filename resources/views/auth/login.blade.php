<x-guest-layout>
    ...
    <div class="w-full max-w-sm mx-auto">
        <h2 class="text-3xl font-bold font-serif text-gray-900 my-6">Selamat Datang Kembali</h2>
                ...
                <div class="flex items-center justify-between mb-1">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}"
                            class="text-xs text-gray-400 hover:text-primary transition-colors">Lupa sandi?</a>
                    @endif
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    Belum memiliki akun? <a href="{{ route('register') }}"
                        class="font-bold text-[#A07954] hover:underline">Daftar</a>
                </p>
            </div>
        </form>
    </div>
