...
use App\Models\EncyclopediaTip;
    ...
    public function run(): void
    {
        ...
        $entries = [
            [
                ...
                'content'     => 'Burnout adalah kondisi kelelahan fisik, emosional, dan mental yang disebabkan oleh stres kronis yang berkepanjangan. Ini lebih dari sekadar lelah biasa — ini adalah sinyal serius bahwa tubuh dan pikiranmu membutuhkan perhatian khusus.anda-tanda burnout meliputi rasa kelelahan yang tidak hilang meski sudah beristirahat, kehilangan motivasi, sulit berkonsentrasi, dan merasa sinisme terhadap pekerjaan atau aktivitas yang biasanya kamu sukai.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Kecemasan adalah emosi alami yang dialami setiap manusia. Ia hadir sebagai respons tubuh terhadap situasi yang dianggap mengancam. Menyadari bahwa kecemasan adalah sebuah sinyal — bukan musuh — adalah langkah pertama menuju ketenangan.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Kesepian adalah pengalaman subjektif di mana seseorang merasa terputus dari orang lain. Ini bukan hanya tentang sendirian secara fisik, tapi tentang merasa tidak dipahami atau tidak terhubung secara emosional.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Ketenangan adalah kondisi mental dan emosional yang ditandai dengan keseimbangan, penerimaan, dan kejernihan pikiran. Ini adalah tujuan banyak praktik meditasi dan mindfulness, dan dapat dilatih meski berada di tengah situasi penuh tekanan.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Kesedihan adalah respons emosional alami terhadap kehilangan atau kekecewaan. Mengizinkan diri untuk bersedih adalah bagian penting dari proses penyembuhan — menekannya justru memperlambat pemulihan.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Rasa syukur adalah praktik sadar untuk mengakui dan menghargai hal-hal baik dalam hidup. Penelitian psikologi positif menunjukkan bahwa rasa syukur yang dilatih secara rutin dapat meningkatkan kesejahteraan emosional secara signifikan.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Kemarahan adalah emosi yang kuat dan seringkali disalahpahami. Alih-alih menekan atau meledakkannya, belajar memahami dan mengelola kemarahan adalah keterampilan emosional yang sangat berharga.',
                'tips'        => json_encode([
            ...
            [
                ...
                'content'     => 'Rasa malu berbeda dengan rasa bersalah. Bersalah berkata "Aku melakukan sesuatu yang buruk", sedangkan malu berkata "Aku adalah sesuatu yang buruk." Memahami perbedaan ini adalah langkah pertama untuk menyembuhkannya.',
                'tips'        => json_encode([
        ...
        foreach ($entries as $entry) {
            ...
            $encyclopedia = Encyclopedia::create($entry);
